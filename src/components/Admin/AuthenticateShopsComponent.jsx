...
const AuthenticateShopsComponent = () => {
    ...
    const [] = useState({ TeamPart: '', TeamDetails: '' });
    const []=useState('');
   
   const AuthentiacteFunc=(id)=>{

    axios.put(`http://localhost:3000/shops/${id}`, {"isAuthenticated":true})
    .then(() => {
       // window.location.reload(false);
        ...
        store.addNotification({
            title: "Success !",
            message: "Successfully Authenticated Shop",
            type: "success",
            insert: "top",
...
export default AuthenticateShopsComponent;