...
const AddSanitaryComponent = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (credentials.name === '' || credentials.quantitie ==='' || credentials.sanitary_type === '' || credentials.price ===''|| credentials.details ==='' ){
        ...
        axios.post(`http://localhost:3000/shops/${id}/sanitary`, credentials)
        .then(res => {
            // console.log(res);
